							...
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="num-text text-black font-w700">$<?php echo $row['Balance']?></h2>
										<span class="fs-14">Account Balance</span>
									</div>
					...
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
						...
						<div class="bg-warning card-border"></div>
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="num-text text-black font-w700">$ <?php echo $row['Total_earnings']?></h2>
...
<!-- Mirrored from fasto.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Jun 2021 08:40:31 GMT -->
</html>