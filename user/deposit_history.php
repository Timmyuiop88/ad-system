    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">Spectro</a>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Spectro </li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
...
$sql="SELECT * FROM `history` WHERE unique_id='$_SESSION[uin]' && type='deposit' ORDER BY id DESC   ";
