...
$sql="SELECT * FROM `ad` ORDER BY id DESC LIMIT 0, 10   ";
...
?>
                                            <tr>
                                                ...
                                                <td><img src="../admin/ad/<?php echo $row['ad_image']?>" class="form-control"></td>
                                            
                                                <td><?php echo $row['date']?></td>
                                                <td><a href="view_ad.php?ad_id=<?php echo $row['ain']?>" class="btn btn-success"> Claim Reward</a></td>
                                            </tr>
