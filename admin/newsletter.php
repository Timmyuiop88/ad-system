...
?>
                        <option value="<?php echo $row['pin']?>"><?php echo $row['plan_name']?> Plan users </option>
                        <?php 
                    }
                    }
                ...
                ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Amount"  name="amount" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Reason</label>
                      <textarea name="message" id="myTextarea" class="form-control"></textarea>
                    </div>
