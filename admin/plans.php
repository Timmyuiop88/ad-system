      ...
      <div class="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item d-none d-lg-flex">
            <a class="nav-link" href="new_plan.php">
              <span class="btn btn-primary">+ Create new Plan</span>
            </a>
          </li>
...
?>
                        <tr>
                          ...
                          <td>$
                            <?php echo $row['total_earnings_per_day']?> 
                          </td>
                          <td>
                          <?php echo $row['duration']?> days
                          </td>
                          <td>
                            <?php echo $row['ref_bonus']?> %
                          </td>
                          <td>
                          <a href="edit_plan.php?pin=<?php echo $row['pin']?>">Edit Plan</a>
                          </td>
                        </tr>
