...
<!-- Mirrored from www.urbanui.com/melody/tfemplate/pages/samples/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Sep 2018 06:08:53 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" action="auth.php" method="post">
                ...
                <div class="mt-3">
                    <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="submit" name="submit">SIGN IN</button>
