...
$sql="SELECT * FROM `withdraw` WHERE status='pending Approval' ";
...
?>
                        <tr>
                          ...
                          <td>
                              <a href="man_approve_withdraw.php?win=<?php echo $row['win']?>">
                            Approve
                            </a>       
                                <p>    </p>  
                            <a href="delete_withdraw.php?win=<?php echo $row['win']?>">
                            cancel 
                            </a>
                          </td>
                        </tr>
