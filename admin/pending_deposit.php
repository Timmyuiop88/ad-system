...
<head>
  ...
  <title><?php echo $site_name;?> Pending Deposit</title>
  <!-- plugins:css -->
...
?>
                        <tr>
                          ...
                          <td>
                            <img src="../user/proof/<?php echo $row['proof']?>" alt="prood of payment">
                          </td>
                          <td>
                              <a href="approve_deposit.php?din=<?php echo $row['din']?>">
                            Approve
                            </a>       
                                <p>    </p>  
                            <a href="delete_deposit.php?din=<?php echo $row['din']?>">
                            cancel 
                            </a>
                          </td>
                        </tr>
